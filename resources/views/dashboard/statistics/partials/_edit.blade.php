...
<div class="row">
    <div class="col-md-6">
        <div class="form-group" id="counter">
            <label for="counter_edit_input">@lang('site.counter')</label>
            <input id="counter_edit_input" type="number" name="counter" placeholder="@lang('site.counter')" class="form-control"
                   value="{{ $form_data->counter }}">
            <span id="counter_edit_error" class="help-block"></span>
        </div>
    </div>
</div>
<div class="row">
